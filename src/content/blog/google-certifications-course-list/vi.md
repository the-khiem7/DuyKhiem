---
title: '12 Google Certificates: Danh sách courses Coursera'
description: 'Tổng hợp đầy đủ 12 Google certifications/specializations và danh sách courses/modules kèm thời lượng học.'
...
Bài viết này tổng hợp đầy đủ danh sách courses/modules của 12 Google Professional Certifications và Specializations trên Coursera.

> Ghi chú cập nhật (2026-04-27): Dữ liệu được đối chiếu từ các trang Coursera certificate/specialization để bổ sung đầy đủ 12 mục.

# Bảng tổng hợp nhanh

| # | Chương trình | Số course | Tổng giờ học (ước tính) |
|---|---|---:|---:|
...
Tổng cộng: 1148 giờ học (ước tính theo thông tin hiển thị trên Coursera).
...
Nguồn: [Coursera](https://www.coursera.org/professional-certificates/google-business-intelligence)
...
Nguồn: [Coursera](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/professional-certificates/google-advanced-data-analytics?collectionId=8fp65#courses)
...
Nguồn: [Coursera](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/prompting-essentials-google?collectionId=8fp65#courses)
...
- Dùng mục giờ học để ước lượng kế hoạch học theo tuần.
- Nếu đang chuyển ngành, nên ưu tiên các lộ trình có capstone hoặc phần "job search with AI".
- Thời lượng có thể thay đổi theo cập nhật của Coursera, nên kiểm tra lại trước khi lập kế hoạch học chi tiết.
