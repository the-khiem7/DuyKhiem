...
1. [Introduction to AI](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/ai-essentials-google?collectionId=8fp65) - Course 1 (1 hour)
2. [Maximize Productivity With AI Tools](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/ai-essentials-google?collectionId=8fp65) - Course 2 (2 hours)
3. [Discover the Art of Prompting](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/ai-essentials-google?collectionId=8fp65) - Course 3 (2 hours)
4. [Use AI Responsibly](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/ai-essentials-google?collectionId=8fp65) - Course 4 (1 hour)
5. [Stay Ahead of the AI Curve](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/specializations/ai-essentials-google?collectionId=8fp65) - Course 5 (2 hours)
...
9. [Accelerate Your Job Search with AI](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/professional-certificates/google-cybersecurity?collectionId=8fp65) (6 hours)
...
1. [Foundations of User Experience (UX) Design](https://www.coursera.org/learn/foundations-user-experience-design?specialization=google-ux-design) (12 hours)
2. [Start the UX Design Process: Empathize, Define, and Ideate](https://www.coursera.org/learn/start-ux-design-process?specialization=google-ux-design) (20 hours)
3. [Build Wireframes and Low-Fidelity Prototypes](https://www.coursera.org/learn/wireframes-low-fidelity-prototypes?specialization=google-ux-design) (12 hours)
4. [Conduct UX Research and Test Early Concepts](https://www.coursera.org/learn/conduct-ux-research?specialization=google-ux-design) (15 hours)
5. [Create High-Fidelity Designs and Prototypes in Figma](https://www.coursera.org/learn/high-fidelity-designs-prototype?specialization=google-ux-design) (19 hours)
6. [Build Dynamic User Interfaces (UI) for Websites](https://www.coursera.org/learn/responsive-web-design-adobe-xd?specialization=google-ux-design) (15 hours)
7. [Design a User Experience for Social Good & Prepare for Jobs](https://www.coursera.org/learn/ux-design-jobs?specialization=google-ux-design) (13 hours)
8. [Accelerate Your Job Search with AI](https://www.coursera.org/learn/accelerate-your-job-search-with-ai?specialization=google-ux-design) (6 hours)
...
1. [Crash Course on Python](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/python-crash-course?specialization=google-it-automation) (21 hours)
2. [Using Python to Interact with the Operating System](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/python-operating-system?specialization=google-it-automation) (33 hours)
3. [Introduction to Git and GitHub](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/introduction-git-github?specialization=google-it-automation) (20 hours)
4. [Troubleshooting and Debugging Techniques](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/troubleshooting-debugging-techniques?specialization=google-it-automation) (19 hours)
5. [Configuration Management and the Cloud](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/configuration-management-cloud?specialization=google-it-automation) (18 hours)
6. [Automating Real-World Tasks with Python](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/automating-real-world-tasks-python?specialization=google-it-automation) (17 hours)
7. [Accelerate Your Job Search with AI](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/accelerate-your-job-search-with-ai?specialization=google-it-automation) (6 hours)
...
1. [Foundations of Business Intelligence](https://www.coursera.org/learn/foundations-of-business-intelligence?specialization=google-business-intelligence) (15 hours)
2. [The Path to Insights: Data Models and Pipelines](https://www.coursera.org/learn/the-path-to-insights-data-models-and-pipelines?specialization=google-business-intelligence) (17 hours)
3. [Decisions, Decisions: Dashboards and Reports](https://www.coursera.org/learn/decisions-decisions-dashboards-and-reports?specialization=google-business-intelligence) (18 hours)
4. [Accelerate Your Job Search with AI](https://www.coursera.org/learn/accelerate-your-job-search-with-ai?specialization=google-business-intelligence) (6 hours)
...
1. [Foundations of Data Science](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/foundations-of-data-science?specialization=google-advanced-data-analytics) (20 hours)
2. [Go Beyond the Numbers: Translate Data into Insights](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/go-beyond-the-numbers-translate-data-into-insight?specialization=google-advanced-data-analytics) (28 hours)
3. [The Power of Statistics](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/the-power-of-statistics?specialization=google-advanced-data-analytics) (31 hours)
4. [Regression Analysis: Simplify Complex Data Relationships](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/regression-analysis-simplify-complex-data-relationships?specialization=google-advanced-data-analytics) (28 hours)
5. [The Nuts and Bolts of Machine Learning](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/the-nuts-and-bolts-of-machine-learning?specialization=google-advanced-data-analytics) (34 hours)
6. [Google Advanced Data Analytics Capstone](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/google-advanced-data-analytics-capstone?specialization=google-advanced-data-analytics) (6 hours)
7. [Accelerate Your Job Search with AI](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/accelerate-your-job-search-with-ai?specialization=google-advanced-data-analytics) (6 hours)
...
1. [Start Writing Prompts like a Pro](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/google-start-writing-prompts-like-a-pro?specialization=prompting-essentials-google) (2 hours)
2. [Design Prompts for Everyday Work Tasks](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/google-design-prompts-for-everyday-work-tasks?specialization=prompting-essentials-google) (1 hour)
3. [Speed Up Data Analysis and Presentation Building](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/google-speed-up-data-analysis-and-presentation-building?specialization=prompting-essentials-google) (1 hour)
4. [Use AI as a Creative or Expert Partner](https://www.coursera.org/programs/gcc-x-fpt-hcm-rkdmg/learn/google-use-ai-as-a-creative-or-expert-partner?specialization=prompting-essentials-google) (2 hours)
